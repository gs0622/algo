...
char *strstr_bm(const char *string, const char *pat)
{
    int i;
    int delta1[ALPHABET_LEN];
    int m = strlen(string), n = strlen(pat);
    int *delta2 = (int *)malloc(n * sizeof(int));
    make_delta1(delta1, (uint8_t *)pat, n);
    make_delta2(delta2, (uint8_t *)pat, n);
...
int main(int argc, char *argv[])
{
    ...
    s = strstr_bm(argv[1], argv[2]); /*argv[1]=string, argv[2]=pattern*/
    if (s)
